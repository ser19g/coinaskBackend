...
// model MainCategory
const TopFollowupSchema = new mongoose.Schema({
  status: {type:String},
...
if(this.title){
  TopFollowupSchema.pre('save', function(next) {
...
const TopFollowup = mongoose.model("TopFollowup", TopFollowupSchema);

module.exports = TopFollowup;