...
// model MainCategory
const TopOpinionSchema = new mongoose.Schema({
  status: {type:String},
...
if(this.title){
  TopOpinionSchema.pre('save', function(next) {
...
const TopOpinion = mongoose.model("TopOpinion", TopOpinionSchema);

module.exports = TopOpinion;