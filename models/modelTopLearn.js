...
// model MainCategory
const TopLearnSchema = new mongoose.Schema({
  status: {type:String},
...
if(this.title){
  TopLearnSchema.pre('save', function(next) {
...
const TopLearn = mongoose.model("TopLearn", TopLearnSchema);

module.exports = TopLearn;