...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'coinstatsopenapi/1.0 (api/6.1.2)');
    }
    /**
     ...
     *
     */
    SDK.prototype.getWalletBalances = function (metadata) {
     ...
     * <b> 10 credits per request </b>
     *             <hr>
     *         This endpoint allows you to retrieve portfolio chart data by time ranges
     * displayed on the CoinStats website.</hr>
     *
     */
    SDK.prototype.getPortfolioChart = function (metadata) {
     ...
     *
     */
    SDK.prototype.addPortfolioTransaction = function (body, metadata) {
